...
Super Safe Protection
    ...
    sleep               2
    waitForPageContain  xpath=(.//*[normalize-space(text()) and normalize-space(.)='Boleh saya tahu nama kamu?'])[1]/following::button[1]
    click               xpath=(.//*[normalize-space(text()) and normalize-space(.)='Boleh saya tahu nama kamu?'])[1]/following::button[1]
    waitForPageContain  xpath=(//section[@id='sovia']/div/div[3]/div/div/div/div/div/div[2])
    click               xpath=(//section[@id='sovia']/div/div[3]/div/div/div/div/div/div[2])
